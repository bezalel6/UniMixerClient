...
WifiConnectionStatus getWifiStatus(void) { return currentWifiStatus; }
...
const char *getSsid(void) { return currentSsid.c_str(); }

const char *getIpAddress(void) { return currentIpAddress.c_str(); }
...
bool isConnected(void) { return currentWifiStatus == WIFI_STATUS_CONNECTED; }
...
void reconnectWifi(void) {
    WiFi.disconnect();
    // Remove blocking delay - use task delay in multithreaded environment
...
bool isAutoReconnectEnabled(void) { return autoReconnectEnabled; }

bool isOtaReady(void) { return otaInitialized; }
