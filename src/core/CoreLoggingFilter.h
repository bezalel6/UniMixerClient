...
// Forward declaration for SerialEngine mutex
namespace Messaging {
class SerialEngine;
}
 ...
 *
 * CRITICAL: Now includes Serial access synchronization to prevent
 * race conditions between ESP_LOG and SerialEngine.
 *
