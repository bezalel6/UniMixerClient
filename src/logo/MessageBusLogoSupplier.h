...
//   bool requestLogo(const char *processName,
//                    AssetRequestCallback callback) override;
//   void update() override;
//   String getStatus() const override;
//   const char *getSupplierType() const override { return "MessageBus"; }

//   // Configuration
//   void setRequestTimeout(unsigned long timeoutMs) {
...
//   void completeRequest(const String &requestId, const AssetResponse
//   &response); void failRequest(const String &requestId, const char
//   *errorMessage); void processQueuedRequests(); void
//   processNextQueuedRequest(); bool saveAssetToStorage(const AssetResponse
//   &response);
